  ...
  return (
    <section className="mt-6 border-t border-slate-200 pt-5 space-y-4">
      <div className="flex flex-wrap items-center justify-between gap-3">
        <div>
          <h3 className="text-sm font-bold text-[#082a30]">Inspection Evidence Photos</h3>
          <p className="text-xs text-slate-500">Upload clear photos of vehicle exterior, interior, engine bay, and any defects.</p>
        </div>

        <label
          className={`inline-flex items-center gap-2 rounded-xl bg-[#082a30] px-4 py-2.5 text-xs font-bold text-white shadow-sm transition-all cursor-pointer hover:bg-[#163452] ${
