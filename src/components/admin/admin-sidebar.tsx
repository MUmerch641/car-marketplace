...
import { CarFront, ClipboardCheck, LayoutDashboard, Settings2, ShieldCheck, UsersRound, Wrench } from "lucide-react";
...
export function AdminSidebar() {
  ...
  return (
    <aside className="flex min-h-full w-full flex-col bg-[#071a2d] text-slate-300 md:fixed md:inset-y-0 md:left-0 md:z-30 md:h-screen md:w-64">
      ...
      <nav className="flex gap-1 overflow-x-auto p-3 md:flex-1 md:flex-col md:gap-1 md:space-y-0 md:overflow-x-hidden md:overflow-y-auto md:p-4">
